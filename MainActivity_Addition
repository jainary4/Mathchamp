...
public class MainActivity_Addition extends AppCompatActivity {
    ...
    private LinearLayout sum_result;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        matrixLayout1 = findViewById(R.id.matrixLayout1_a);
        matrixLayout2 = findViewById(R.id.matrixLayout2_a);
        sum_result = findViewById(R.id.sum_result);  // Add this line to initialize sum_result
        buttonGenerateMatrices = findViewById(R.id.buttonGenerateMatrices_a);
        ...
        buttoncalculate = findViewById(R.id.buttonCalculate_a);
        buttoncalculate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (l1 != null && l2 != null) {
                    ...
                    Matrix result = layout1.add(layout2);
                    if (result != null) {
                        generateResultMatrixLayout(result.matrix);
                    } else {
                        Toast.makeText(MainActivity_Addition.this, "Incompatible matrices... Make sure of same dimension", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    Toast.makeText(MainActivity_Addition.this, "Please fill in all matrix values", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
